...
[role="lead"]
您可以在Linux平台上下載並執行安裝檔案、從Unified Manager 9.8或9.9升級至9.10。
...
* MySQL Community Edition會在Unified Manager升級期間自動升級。如果您系統上安裝的MySQL版本早於8.0.27、Unified Manager升級程序會自動將MySQL升級至8.0.27。
